(** * vectors.bip340_v12: BIP-340 test vector 12. *)
(** Copyright (C) 2026 remix7531
    SPDX-License-Identifier: MIT *)

(** Verification result FALSE, verify only. The BIP's comment: sig[0:32]
    is equal to field size. The lemma is a parse failure and runs in
    seconds; the file is here so that every vector has one file. The
...
Program Definition v12_pk : Array (Word 8) 32 :=
  bytes_of_Z 0xDFF1D77F2A671C5F36183726DB2341BE58FEAE1DA2DECED843240F7B502BA659 32 _.
Program Definition v12_msg : Array (Word 8) 32 := @words 8 [
    0x24; 0x3f; 0x6a; 0x88; 0x85; 0xa3; 0x08; 0xd3;
    0x13; 0x19; 0x8a; 0x2e; 0x03; 0x70; 0x73; 0x44;
    0xa4; 0x09; 0x38; 0x22; 0x29; 0x9f; 0x31; 0xd0;
    0x08; 0x2e; 0xfa; 0x98; 0xec; 0x4e; 0x6c; 0x89
  ] _.
Program Definition v12_sig : Array (Word 8) 64 :=
  bytes_of_Z
...
Lemma bip340_v12_signature_parse_fails :
  (decode v12_sig : option Signature) = None.
Proof.
