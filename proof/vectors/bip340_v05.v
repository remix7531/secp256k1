(** * vectors.bip340_v05: BIP-340 test vector 5. *)
(** Copyright (C) 2026 remix7531
    SPDX-License-Identifier: MIT *)

(** Verification result FALSE, verify only. The BIP's comment: public
    key not on the curve. The lemma is a parse failure and runs in
...
Program Definition v5_pk : Array (Word 8) 32 :=
  bytes_of_Z 0xEEFDEA4CDB677750A420FEE807EACF21EB9898AE79B9768766E4FAA04A2D4A34 32 _.

Lemma bip340_v5_pubkey_parse_fails : xonly_decode v5_pk = None.
Proof.
