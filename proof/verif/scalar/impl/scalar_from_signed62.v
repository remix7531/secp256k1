(** * verif.scalar.scalar_from_signed62: body proof for secp256k1_scalar_from_signed62 *)
...
(** The C cross-limb combine [(lo >> c) | (hi << (62 - c))], as a [Z], is
    ...
    shared [lor_disjoint_is_add], theory/limb_window.v). *)
...
Proof.
  ...
  - f_equal.
    ...
    { split; [apply Z.div_pos; [lia | lia] |].
      ...
      unfold constants.secp256k1_N in H.
