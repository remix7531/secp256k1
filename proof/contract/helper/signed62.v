(** * contract.helper.signed62: the [Signed62] little-endian limb representation +
...
(** Hoisted out of [contract/modinv.v] so the scalar <-> signed62 bridge specs
    and the public inverse funspecs can live in the scalar layer (which sits
    below [contract/modinv.v]) without depending on the modinv contract.  This
    ...
    layering-sound below [contract/scalar.v].
...
(** Shorthand for the modinv [data_at] resources, mirroring [contract/helper/
    ...
    live above the [contract/helper/notations] layer. *)
