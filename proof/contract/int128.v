(** * contract.int128: funspecs for the 128-bit arithmetic helpers. *)
...
(** Mirrors the PUBLIC [src/int128.h] surface: the unsigned [secp256k1_u128_*]
    ...
    specified in [contract/impl/int128.v]. *)
...
(** ([secp256k1_umul128] is internal -- see [contract/impl/int128.v].) *)
...
(** The signed [secp256k1_i128_*] helpers.  In the struct backend
    ...
    [int128_struct_impl.h], are internal -- see [contract/impl/int128.v].) *)
...
(** ([secp256k1_i128_dissip_mul] is internal -- see [contract/impl/int128.v].) *)
