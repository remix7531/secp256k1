(** * contract.gprog.jacobi: the Jacobi funspec context. *)
(** Copyright (C) 2026 remix7531
    SPDX-License-Identifier: MIT *)

(** The ONLY context containing [spec_secp256k1_jacobi64_maybe_var].
    No body proof is included, and no other subsystem's proof can
    [forward_call] it structurally. *)
