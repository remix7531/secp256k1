(** * theory.int128.int128: pure functional model of the 64/128/192/256/512-bit integers *)
...
Require Export secp256k1.theory.integers.machine.
...
(** ** Unsigned operations -- [mul_64] / [u128_lo] / [u256_limb].
    (The word types [UInt64] .. [UInt512] live in [theory/integers/machine.v]; the
    accumulator [Acc] in [theory/int128/acc.v].) *)
...
(** ** Signed operations -- [mul_i64] / [i128_det] / [i128_hi].
    ([Int64] / [Int128] live in [theory/integers/machine.v].) *)
