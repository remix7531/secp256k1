(** * vst.helper.repr: model-to-C representation predicates (machine
    words + bytes -- FROZEN; each subsystem owns its further bridges, e.g.
    [fe_to_val] in [vst/field/contract.v]). *)
...
(** The spatial-predicate notation ([u64_at], [u128_at], [scalar_at], ...)
    that wraps these [*_to_val] bridges lives in [vst/helper/notations.v]. *)
