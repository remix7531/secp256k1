(** * vst.helper.notations: spatial-predicate notation for the C
    representations (machine words + bytes -- FROZEN; each subsystem owns its
    further [_at] notations, e.g. [fe_at] in [vst/field/contract.v]). *)
...
Require Export secp256k1.vst.helper.repr.
