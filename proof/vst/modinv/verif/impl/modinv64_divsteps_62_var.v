(** * vst.modinv.verif.impl.modinv64_divsteps_62_var: body proof for secp256k1_modinv64_divsteps_62_var. *)
...
Proof.
  ...
  - (* ===== Loop body: cancel the trailing zeros of g, then one divstep round ===== *)
    ...
    (* Hgcd: an odd number is coprime to every power of two ([theory/integers/bits.v]) *)
