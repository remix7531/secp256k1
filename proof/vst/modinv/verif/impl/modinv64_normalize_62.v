(** * vst.modinv.verif.impl.modinv64_normalize_62: body proof for secp256k1_modinv64_normalize_62. *)
...
Proof.
  ...
  (* Pure-Z mask vocabulary ([theory/integers/bits.v]), posed under the names the rest of
