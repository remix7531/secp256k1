(** * vst.int128.impl: INTERNAL funspecs for the 128-bit helpers. *)
...
(** Mirrors [src/int128_struct_impl.h]: the funspecs here are for the [static]
    ...
    in [vst/int128/contract.v]; this file's own [Gprog_int128_impl], below, is
    what [vst/gprog.v] concatenates. *)
...
(* ================================================================= *)
(** ** The module's internal funspec list -- the [static] helpers.

    Separate from [Gprog_int128_public] for one structural reason: this file
    and [vst/int128/contract.v] do not import each other, so neither can hold
    the other's names.  [vst/gprog.v] concatenates them. *)

Definition Gprog_int128_impl : funspecs := [
