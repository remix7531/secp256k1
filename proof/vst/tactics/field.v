(** * vst.tactics.field: field-subsystem automation (the future prove_fe_linear home). *)
(** Copyright (C) 2026 remix7531
    SPDX-License-Identifier: MIT *)

(** The op-independent scaffolding factored out of the first field body proof
    (vst/field/verif/fe_add).  Every carry-free 5x52 field linear op -- [fe_add] now,
    ...
    lemma layer and vst/field/verif/fe_add.v is the worked exemplar to clone from. *)
