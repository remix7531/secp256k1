(** * vst.scalar.verif.get_bits_limb32: body proof for secp256k1_scalar_get_bits_limb32. *)
...
(** Returns [(a >> offset) mod 2^count] when the window lies within one limb.
    ...
    [limb_window] (theory/integers/limb_window.v); the full C-value -> Z reduction is the
    file-local [INTRED]. *)
