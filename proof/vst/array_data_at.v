(** * vst.array_data_at: equality between an array [data_at] and the
...
(* ================================================================= *)
(** ** Generic array decomposition -- [iter_data_at_*] / [data_at_tarray_iter_*]. *)
...
(* ================================================================= *)
(** ** Size-8 entailment wrappers -- [fold]/[unfold] [tarray tulong 8] <-> 8 slots. *)
...
(* ================================================================= *)
(** ** Single-slot bridges -- [tarray tulong N] slot <-> standalone [tulong] ([slot_field_at*]).
