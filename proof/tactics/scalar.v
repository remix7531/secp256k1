(** * tactics.scalar: scalar-subsystem automation (N constants, carry bridges,
...
(** [secp256k1_N]'s decimal value bridge ([secp256k1_N_val]) lives in
    [model.constants] and is registered with [rep_lia] there: the constant is
